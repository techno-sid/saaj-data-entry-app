...
function PrintLabels({ showToast, settings }) {
    ...
    if (settings?.aiAutofillEnabled === false) {
      ...
      try {
        ...
        if (result) {
          ...
          showToast('Recipient autofilled successfully (Local Mode)!');
            ...
            >
              ...
              <div className="flex justify-between items-center border-b border-outline-variant/60 pb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <span className="material-symbols-outlined text-xs font-bold">{settings?.aiAutofillEnabled === false ? 'schema' : 'auto_awesome'}</span>
                    <span>{autofillIndex === index ? 'Close' : (settings?.aiAutofillEnabled === false ? 'Ai Magic' : 'Ai Magic')}</span>
                  </button>
